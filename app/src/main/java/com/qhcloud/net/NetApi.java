...
public class NetApi {
     ...
     * @param seq
     * @return  返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_GET_FRIEND_VERSION_RSP  数据:ArrayList<FriendVersion>
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_GET_FRIEND_REMARKS_INFO_QUERY_RSP 数据:ArrayList<FriendRemark>
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_GET_FRIEND_BASE_INFO_QUERY_RSP 数据:ArrayList<BaseInfo>
     */
     ...
     * 获取登录用户的基本信息
     * @return 0-成功，其他-错误码
     * 回调命令： QHC_CMD_GET_SINGLE_FRIEND_BASE_INFO_QUERY_RSP 116 数据:BaseInfo
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_DELETE_FIREND_RSP
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_SET_FRIEND_REMARKS_RSP
     */
     ...
     * @param seq　
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_UID_QUERY_RSP 数据：Integer
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_CTRL_MSG_RSP 数据：SettingParams
     */
     ...
     * @param seq
     * @return   返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_ACCOUNT_QUERY_RSP  数据：AccountInfo
     */
     ...
     * @param seq
     * @return 返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_ACCOUNT_MODIFY_RSP
     */
     ...
     * @param seq
     * @return 返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_MODIFY_PASSWORD_RSP　
     */
     ...
     * @param seq
     * @return 返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_GET_DEV_FRIEND_CNT_RSP 数据：List<Integer>
     */
     ...
     * @param seq
     * @return  返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_GET_DEV_FINFO_RSP 数据：List<DevFriendInfo>
     */
     ...
     * @param seq
     * @return 返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_DEL_DEV_FRIEND_RSP
     */
     ...
     * @param seq
     * @return 返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_MODIFY_DEV_FREMARKS
     */
     ...
     * @param seq
     * @return 返回值： 0-成功，其他-错误码
     *  回调命令： QHC_CMD_MODIFY_DEV_FPERMISSION
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_UPLOAD_FILE_RSP 数据：UploadFileResultInfo
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_FINISH_UPLOAD_FILE_RSP 数据：UploadFileFihishiInfo
     */
     ...
     * @param msg_req　
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_DOWN_FILE_RSP 数据：DownloadFileResultInfo
     */
     ...
     * @param msg_req
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_FINISH_DOWN_FILE_RSP 数据：DownloadFileResultInfo
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GET_MODIFY_MGR_RSP
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GET_CLIENT_VERSION_RSP VersionInfo
     */
     ...
     * @param system
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_UPLOAD_ACTION_RSP
     */
     ...
     * @param seq
     * @return  返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_DEV_FAMILY_GET_MEM_LIST_RSP  数据：List<Integer>
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_DEV_FAMILY_GET_MEM_INFO_RSP  数据：List<FamilyMemberInfo>
     */
     ...
     * 获取离线信息
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GET_OFFLINE_CHAT_MSG_RSP  数据：ChatMessage
     * 回调命令： QHC_CMD_ADD_ASK_QUERY_RSP  数据：List<RequestFriend>
     * 回调命令： QHC_CMD_ADD_ANSWER_QUERY_RSP  数据：List<ResponseFriend>
     * 回调命令： QHC_CMD_GET_OFFLINE_SYSTEM_MSGS_RSP  数据：List<SystemMessage>
     * 回调命令： QHC_CMD_GROUP_MSG_PULL_RSP  数据：ChatMessage
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_GROUP_CREATE_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_QUERY_ID_RSP  数据：List<Integer>
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_QUERY_INFO_RSP  数据：List<GroupInfo>
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_SAVE_TO_CONTACTS_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_DEL_FROM_CONTACTS_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_UPDATE_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_OWNERSHIP_TRANSFER_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_QUERY_QRCODE_RSP  数据：GroupQRCode
     */
     ...
     * @param qrcode 二维码
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_QUERY_BY_QRCODE_RSP  数据：GroupInfo
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_JOIN_BY_QRCODE_RSP  数据：result
     */
    public native int joinGroupByQRCode(JoinGroup joinGroup, long seq);

    /**
     * 查询群组版本号 QHC_CMD_GROUP_VERSION_QUERY_RSP
     * @param groupIds 群组ID
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_VERSION_QUERY_RSP  数据：List<GroupVersion>
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_INVITE_MEMBERS_RSP  数据：List<Integer> 失败列表
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_MEMBER_QUERY_RSP  数据：List<GroupMember> 失败列表
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_LEAVE_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_DEL_MEMBERS_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     * 回调命令： QHC_CMD_GROUP_UPDATE_MEMBER_INFO_RSP  数据：result
     */
     ...
     * @param seq
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_GROUP_MSG_SEND_RSP
     */
     ...
     * @param seq 请求ID
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_QRCODE_LINK_ACCOUNT_RSP
     */
     ...
     * @param seq 请求ID
     * @return 返回值：0-成功，其他-错误码
     *  回调命令： QHC_CMD_ALLOW_PC_LOGIN_RSP
     */
    ...
    /**
     * 在线接收到的消息
     *  回调命令： QHC_CMD_RECV_CHAT_MSG ChatMessage
     *  回调命令： QHC_CMD_RECV_ADD_ASK_REQ RequestFriend
     *  回调命令： QHC_CMD_RECV_ADD_ANSWER_REQ AnswerMsg
     *  回调命令： QHC_CMD_SYSTEM_MSG_REQ SystemMessage
     */
