...
import com.qhcloud.demo.entity.Picture;
import com.qhcloud.demo.manager.picture.LoadBitmapManager;
import com.qhcloud.demo.manager.picture.SpacesItemDecoration;
import com.qhcloud.demo.util.FileUtil;
    ...
    private BaseAdapter.OnItemClickListener<Picture> mItemClickListener = new BaseAdapter.OnItemClickListener<Picture>() {
        ...
        public void onItemClick(View view, int position, Picture picture) {
            if (position == 0) {
                ...
                com.qhcloud.demo.app.common.picture.detail.PictureDetailActivity.startActivity(PictureActivity.this, picture.getPath());
            }
        }
    };
